...
> **At a glance:** LeetCode stats in, vintage Hinglish roast card out.
...
> [!IMPORTANT]
> **Key takeaway:** If code runs in the browser, users can inspect it. A git-ignored `.env` file alone does not make frontend secrets safe.
...
3. **How easy it is to steal:** Anyone opening your website can press `F12` (Inspect Element) → **Sources** or **Network** tab, search for `gsk_...` or `AIza...`, and steal your key to use at your expense.
...
> [!NOTE]
> **Tech stack classification:** This is **not** a MERN stack project. MERN requires **M**ongoDB (Database) and **E**xpress (Backend Framework). This app uses Next.js App Router to handle both frontend UI and backend API routes seamlessly without Express or a database.
...
- **To update API keys or AI models:**
  ...
  - Production key: Update **Vercel Dashboard → Settings → Environment Variables**.
